...
| [Shopping AI Agent](https://github.com/redis-developer/shopping-ai-agent-langgraph-js-demo) ⭐ 6 \| 🐛 1 \| 🌐 JavaScript \| 📅 2026-01-18                                                                                         | An Agentic AI grocery-shopping platform demo that combines Redis's speed with LangGraph's workflow orchestration. Get personalized recipe recommendations, smart product suggestions, and lightning-fast responses through semantic caching.                                                                                            |
...
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [RedisVL](https://github.com/redis/redis-vl-python) ⭐ 420 \| 🐛 55 \| 🌐 Python \| 📅 2026-08-12                       | A dedicated Python client lib for Redis as a Vector DB                                    |
...
| [LangChain Python](https://github.com/langchain-ai/langchain) ⭐ 144,121 \| 🐛 412 \| 🌐 Python \| 📅 2026-08-13        | Popular Python client lib for building LLM applications powered by Redis                  |
| [LangChain JS](https://github.com/langchain-ai/langchainjs) ⭐ 18,062 \| 🐛 500 \| 🌐 TypeScript \| 📅 2026-08-13       | Popular JS client lib for building LLM applications powered by Redis                      |
...
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel/tree/main) ⭐ 28,445 \| 🐛 242 \| 🌐 C# \| 📅 2026-08-11 | Popular lib by MSFT to integrate LLMs with plugins                                        |
