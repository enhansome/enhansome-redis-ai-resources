...
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [RedisVL](https://github.com/redis/redis-vl-python) ⭐ 428 \| 🐛 53 \| 🌐 Python \| 📅 2026-09-23                       | A dedicated Python client lib for Redis as a Vector DB                                    |
...
| [LangChain Python](https://github.com/langchain-ai/langchain) ⭐ 146,966 \| 🐛 562 \| 🌐 Python \| 📅 2026-09-24        | Popular Python client lib for building LLM applications powered by Redis                  |
| [LangChain JS](https://github.com/langchain-ai/langchainjs) ⭐ 18,224 \| 🐛 581 \| 🌐 TypeScript \| 📅 2026-09-24       | Popular JS client lib for building LLM applications powered by Redis                      |
...
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel/tree/main) ⭐ 28,594 \| 🐛 320 \| 🌐 C# \| 📅 2026-09-19 | Popular lib by MSFT to integrate LLMs with plugins                                        |
