...
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [RedisVL](https://github.com/redis/redis-vl-python) ⭐ 425 \| 🐛 54 \| 🌐 Python \| 📅 2026-09-04                       | A dedicated Python client lib for Redis as a Vector DB                                    |
...
| [LangChain Python](https://github.com/langchain-ai/langchain) ⭐ 145,674 \| 🐛 449 \| 🌐 Python \| 📅 2026-09-04        | Popular Python client lib for building LLM applications powered by Redis                  |
| [LangChain JS](https://github.com/langchain-ai/langchainjs) ⭐ 18,163 \| 🐛 558 \| 🌐 TypeScript \| 📅 2026-09-04       | Popular JS client lib for building LLM applications powered by Redis                      |
...
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel/tree/main) ⭐ 28,533 \| 🐛 282 \| 🌐 C# \| 📅 2026-09-04 | Popular lib by MSFT to integrate LLMs with plugins                                        |
