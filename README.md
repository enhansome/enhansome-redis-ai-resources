...
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [RedisVL](https://github.com/redis/redis-vl-python) ⭐ 424 \| 🐛 56 \| 🌐 Python \| 📅 2026-08-28                       | A dedicated Python client lib for Redis as a Vector DB                                    |
...
| [LangChain Python](https://github.com/langchain-ai/langchain) ⭐ 145,267 \| 🐛 429 \| 🌐 Python \| 📅 2026-08-30        | Popular Python client lib for building LLM applications powered by Redis                  |
| [LangChain JS](https://github.com/langchain-ai/langchainjs) ⭐ 18,144 \| 🐛 544 \| 🌐 TypeScript \| 📅 2026-08-28       | Popular JS client lib for building LLM applications powered by Redis                      |
...
| [Semantic Kernel](https://github.com/microsoft/semantic-kernel/tree/main) ⭐ 28,520 \| 🐛 264 \| 🌐 C# \| 📅 2026-08-27 | Popular lib by MSFT to integrate LLMs with plugins                                        |
